...
*/
    ...
    LOG_DEBUG("Destination is %s", ((route_hdr != NULL) && !send_to_req_uri) ? "top route header" : "Request-URI");
    pjsip_uri* target = ((route_hdr != NULL) && !send_to_req_uri) ? route_hdr->name_addr.uri : tdata->msg->line.req.uri;
